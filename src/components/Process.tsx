      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold font-display text-white mb-6">
            How We Manage <span className="text-blue-500">Clients</span>
          </h2>
        ...
        <div className="relative">
          {/* Vertical Line */}
          <div className="absolute left-[27px] md:left-1/2 md:-translate-x-1/2 top-0 bottom-0 w-[2px] bg-neutral-800" />
          ...
          <div className="space-y-12 md:space-y-24">
            {steps.map((step, idx) => {
              ...
              return (
                ...
                >
                  {/* Timeline Dot */}
                  <div className="absolute left-0 md:left-1/2 w-14 h-14 -translate-x-0 md:-translate-x-1/2 rounded-full bg-black border-4 border-neutral-800 flex items-center justify-center z-10 text-blue-500 font-bold font-display">
                    {step.number}
                  </div>

                  {/* Content */}
                  <div className={`ml-20 md:ml-0 md:w-1/2 ${isEven ? "md:pl-16" : "md:pr-16"} pt-2`}>
                    <div className="bg-neutral-900/40 border border-neutral-800/50 p-8 rounded-2xl hover:border-blue-500/30 transition-colors">
